  ...
  <div class="w-full bg-white  rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
          ...
          <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">
            ...
            >
              <div class="p-3 space-y-2">
                <h3 class="font-semibold text-gray-900 dark:text-white">Sales - Incremental</h3>
                <p>
                ...
                <a
                  href="#"
                  class="flex items-center font-medium text-red-800 dark:text-red-900 dark:hover:text-red-900 hover:text-red-700 hover:underline"
                >
                  Read more
                  <svg
    ...
    <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between mt-2.5">
      <div class="pt-5">
        <a
          href="#"
          class="px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-red-800 hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-lg text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
        >
          <svg
