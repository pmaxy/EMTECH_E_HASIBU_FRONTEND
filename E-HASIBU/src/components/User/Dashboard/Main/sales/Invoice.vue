...
export default {
  ...
  data() {
   return{ 
     searchQuery: '',
       tableData: [
         {invoiceNumber: '###', status: 'approved', date: '2024-02-18'},
         {invoiceNumber: '###', status: 'paid',  date: '2024-02-02'},
         {invoiceNumber: '###', status: 'declined',  date: '2024-01-18'},
         {invoiceNumber: '###', status: 'unpaid', date: '2023-09-18'},
         {invoiceNumber: '###', status: 'waiting',  date: '2023-05-18'},
  ...
  computed: {
   filteredTableData() {
     return this.tableData.filter(row => {
       ...
       return row.invoiceNumber.toLowerCase().includes(searchTerm) ||
