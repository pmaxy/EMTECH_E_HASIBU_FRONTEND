  ...
  <div class="bg-white mt-3 mb-3 mr-10 ml-5 text-red-800 rounded">
   ...
   <div class="bg-white text-red-800 ml-5 mr-10 mt-2 rounded ">
    ...
    <label for="orderNumber" class="ml-3 mb-2">Order Number: </label>
         <input type="text" id="orderNumber" class="bg-gray-200 ml-2 mt-5 mb-3 mr-2 rounded w-50 pl-2" placeholder="Order Number"  v-model="formvalues.orderNumber">
    </div>
    <div class="bg-white mt-3 mb-3 mr-10 ml-5 text-red-800 rounded">
    <label for="amountPaid" class="ml-3 mb-2">Amount Paid: </label>
         <input type="text" id="amount" class="bg-gray-200 ml-2 mt-5 mb-3 mr-2 rounded w-50 pl-2" placeholder="Amount Paid"  v-model="formvalues.amountPaid">
    </div>
    <div class="bg-white mt-3 mb-3 mr-10 ml-5 text-red-800 rounded">
    ...
    <label for="paymentDate" class="ml-3 mb-2">Payment Date: </label>
         <input type="text" id="paymentDate" class="bg-gray-200 ml-2 mt-5 mb-3 mr-2 rounded w-50 pl-2" placeholder="Payment Date"  v-model="formvalues.paymentDateDate">
    </div>
